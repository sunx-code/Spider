...
public class Qunar implements IMonitor {
	...
	public void monitor(DBFactory factory, Long id, String name) {
		...
		//http://hotel.qunar.com/city/sanya/dt-12418/?_=1#cityurl=sanya&HotelSEQ=sanya_12418&sgroup=1&roomNum=1&from=hoteldetail&fromDate=2016-10-27&toDate=2016-10-29&rnd=1477451160650

		// --------------
		// &from=hoteldetail&fromDate=2016-10-27&toDate=2016-10-29&rnd=1477451160650
		//开始处理,遍历集合,构造数据
